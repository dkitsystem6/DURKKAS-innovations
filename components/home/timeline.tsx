...
const TimelineSection = ({ isDesktop }: IDesktop) => {
  ...
  // Track viewport width for proper mobile/tablet detection
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      ...
      resizeTimeout = setTimeout(() => {
        ...
        // Force refresh by killing all ScrollTriggers first
  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      <p className="section-title-sm seq">Our Innovations</p>
      <h1 className="section-heading seq mt-2">Framework Journey</h1>
      <h2 className="text-lg sm:text-xl md:text-2xl md:max-w-2xl w-full seq mt-2 px-2 md:px-0">
