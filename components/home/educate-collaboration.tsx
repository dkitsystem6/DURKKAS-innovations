...
import { isSmallScreen, NO_MOTION_PREFERENCE_QUERY } from "../../pages/educate";
...
const COLLABORATION_STYLE = {
  ...
  SECTION:
    "w-full relative select-none tall:py-36 py-24 md:py-48 section-container flex flex-col overflow-x-hidden md:overflow-x-visible",
  TITLE: "mt-6 md:mt-8 font-medium text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-center px-4",
};

const EducateCollaborationSection = () => {
  ...
  const renderTitle = () => (
    ...
    >
      Ready to Learn & Grow with <span className="text-strong font-bold" style={{ color: '#FBBF24', background: 'none', WebkitBackgroundClip: 'unset', backgroundClip: 'unset', WebkitTextFillColor: '#FBBF24' }}>DURKKAS</span>?
    </h1>
  );
  ...
  return (
    <section className={COLLABORATION_STYLE.SECTION} ref={targetSection}>
      {renderSlidingText(
        "We educate and empower learners with future-ready skills through guided mentorship and tech-integrated learning. ",
        "ui-left"
      )}
      ...
      {renderSlidingText(
        "Shaping Knowledge, Building Careers, Empowering the Next Generation.",
...
export default EducateCollaborationSection;
