...
import { isSmallScreen, NO_MOTION_PREFERENCE_QUERY } from "../../pages/elevate";
...
const ElevateCollaborationSection = () => {
  ...
  const renderTitle = () => (
    ...
    >
      Ready to Elevate Your Business with <span className="text-strong font-bold" style={{ color: '#FBBF24', background: 'none', WebkitBackgroundClip: 'unset', backgroundClip: 'unset', WebkitTextFillColor: '#FBBF24' }}>DURKKAS</span>?
    </h1>
  );
