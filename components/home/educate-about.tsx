...
const EducateAboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-lg sm:text-xl md:text-3xl lg:text-5xl px-2 md:px-0">
      ...
      >
        It empowers learners with structured programs, experiential training and career pathways that build a knowledgeable, confident and future-focused workforce.
      </span>
    </h1>
  );
...
export default EducateAboutSection;
